 ...
 */
final class Version20210114135634 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cricter_dadmission (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cricter_dadmission_referentiel (cricter_dadmission_id INT NOT NULL, referentiel_id INT NOT NULL, INDEX IDX_BCA13EE5AF0A0EAE (cricter_dadmission_id), INDEX IDX_BCA13EE5805DB139 (referentiel_id), PRIMARY KEY(cricter_dadmission_id, referentiel_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cricter_devaluation (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cricter_devaluation_referentiel (cricter_devaluation_id INT NOT NULL, referentiel_id INT NOT NULL, INDEX IDX_2253294418DE8E8F (cricter_devaluation_id), INDEX IDX_22532944805DB139 (referentiel_id), PRIMARY KEY(cricter_devaluation_id, referentiel_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cricter_dadmission_referentiel ADD CONSTRAINT FK_BCA13EE5AF0A0EAE FOREIGN KEY (cricter_dadmission_id) REFERENCES cricter_dadmission (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cricter_dadmission_referentiel ADD CONSTRAINT FK_BCA13EE5805DB139 FOREIGN KEY (referentiel_id) REFERENCES referentiel (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cricter_devaluation_referentiel ADD CONSTRAINT FK_2253294418DE8E8F FOREIGN KEY (cricter_devaluation_id) REFERENCES cricter_devaluation (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cricter_devaluation_referentiel ADD CONSTRAINT FK_22532944805DB139 FOREIGN KEY (referentiel_id) REFERENCES referentiel (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cricter_dadmission_referentiel DROP FOREIGN KEY FK_BCA13EE5AF0A0EAE');
        $this->addSql('ALTER TABLE cricter_devaluation_referentiel DROP FOREIGN KEY FK_2253294418DE8E8F');
        ...
        $this->addSql('ALTER TABLE cricter_dadmission_referentiel DROP FOREIGN KEY FK_BCA13EE5805DB139');
        $this->addSql('ALTER TABLE cricter_devaluation_referentiel DROP FOREIGN KEY FK_22532944805DB139');
        ...
        $this->addSql('DROP TABLE cricter_dadmission');
        $this->addSql('DROP TABLE cricter_dadmission_referentiel');
        $this->addSql('DROP TABLE cricter_devaluation');
        $this->addSql('DROP TABLE cricter_devaluation_referentiel');
