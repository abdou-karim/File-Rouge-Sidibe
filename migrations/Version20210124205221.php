 ...
 */
final class Version20210124205221 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cricter_dadmissions (id INT AUTO_INCREMENT NOT NULL, referentiel_id INT NOT NULL, libelle VARCHAR(255) NOT NULL, INDEX IDX_42D9C3E5805DB139 (referentiel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cricter_devaluations (id INT AUTO_INCREMENT NOT NULL, referentiel_id INT NOT NULL, libelle VARCHAR(255) NOT NULL, INDEX IDX_98014376805DB139 (referentiel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cricter_dadmissions ADD CONSTRAINT FK_42D9C3E5805DB139 FOREIGN KEY (referentiel_id) REFERENCES referentiel (id)');
        $this->addSql('ALTER TABLE cricter_devaluations ADD CONSTRAINT FK_98014376805DB139 FOREIGN KEY (referentiel_id) REFERENCES referentiel (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cricter_dadmissions DROP FOREIGN KEY FK_42D9C3E5805DB139');
        $this->addSql('ALTER TABLE cricter_devaluations DROP FOREIGN KEY FK_98014376805DB139');
