 ...
 */
final class Version20210124205858 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cricter_dadmissions (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cricter_dadmissions_referentiel (cricter_dadmissions_id INT NOT NULL, referentiel_id INT NOT NULL, INDEX IDX_52CC235CD6B039C4 (cricter_dadmissions_id), INDEX IDX_52CC235C805DB139 (referentiel_id), PRIMARY KEY(cricter_dadmissions_id, referentiel_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cricter_devaluations (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cricter_devaluations_referentiel (cricter_devaluations_id INT NOT NULL, referentiel_id INT NOT NULL, INDEX IDX_F38342359A6EFD1A (cricter_devaluations_id), INDEX IDX_F3834235805DB139 (referentiel_id), PRIMARY KEY(cricter_devaluations_id, referentiel_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE profil (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, archivage TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_E6D6B297A4D60759 (libelle), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE referentiel (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, presentation VARCHAR(255) NOT NULL, programme LONGBLOB NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cricter_dadmissions_referentiel ADD CONSTRAINT FK_52CC235CD6B039C4 FOREIGN KEY (cricter_dadmissions_id) REFERENCES cricter_dadmissions (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cricter_dadmissions_referentiel ADD CONSTRAINT FK_52CC235C805DB139 FOREIGN KEY (referentiel_id) REFERENCES referentiel (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cricter_devaluations_referentiel ADD CONSTRAINT FK_F38342359A6EFD1A FOREIGN KEY (cricter_devaluations_id) REFERENCES cricter_devaluations (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cricter_devaluations_referentiel ADD CONSTRAINT FK_F3834235805DB139 FOREIGN KEY (referentiel_id) REFERENCES referentiel (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cricter_dadmissions_referentiel DROP FOREIGN KEY FK_52CC235CD6B039C4');
        $this->addSql('ALTER TABLE cricter_devaluations_referentiel DROP FOREIGN KEY FK_F38342359A6EFD1A');
        ...
        $this->addSql('ALTER TABLE cricter_dadmissions_referentiel DROP FOREIGN KEY FK_52CC235C805DB139');
        $this->addSql('ALTER TABLE cricter_devaluations_referentiel DROP FOREIGN KEY FK_F3834235805DB139');
        ...
        $this->addSql('DROP TABLE cricter_dadmissions');
        $this->addSql('DROP TABLE cricter_dadmissions_referentiel');
        $this->addSql('DROP TABLE cricter_devaluations');
        $this->addSql('DROP TABLE cricter_devaluations_referentiel');
