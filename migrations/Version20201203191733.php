 ...
 */
final class Version20201203191733 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apprenants CHANGE promotion_id promotion_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apprenants CHANGE promotion_id promotion_id INT NOT NULL');
    }
}
